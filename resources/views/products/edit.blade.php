...
<body class="px-2">
    <section class="w-full md:w-2/3 lg:w-1/2 mx-auto mt-4 bg-slate-400 p-5 rounded-xl shadow-lg">
        <div class="bg-black rounded-xl text-white w-full h-16 justify-center flex items-center mb-4">
            <h1 class=" text-center font-bold text-3xl">Edit Product</h1>
        </div>
        <a href="{{ url('/products') }}"
                    ...
                    <table class="table-auto w-full mt-4 bg-white shadow-lg">
                        <tr>
                            ...
                            <td class=" p-2 border-l-2 border-slate-200">
                                <input type="text" name="name" required class="border border-slate-300 rounded-md px-2 py-1 w-full" value="{{ $product->name }}" >
                            </td>
                        </tr>
                        <tr>
                            <td class="px-2 py-1"><strong>Description :</strong></td>
                            <td class="p-2 border-l-2 border-slate-200">
                                <input type="text" name="description" required class="border border-slate-300 rounded-md px-2 py-1 w-full" value="{{ $product->description }}" >
                            </td>
                        </tr>
                        <tr>
                            <td class="px-2 py-1"><strong>Price :</strong></td>
                            <td class="p-2 border-l-2 border-slate-200">
                                <input type="number" name="price" required class="border border-slate-300 rounded-md px-2 py-1 w-full" value="{{ $product->price }}" >
                            </td>
                        </tr>
                        <tr>
                            <td class="px-2 py-1"><strong>Stock :</strong></td>
                            <td class="p-2 border-l-2 border-slate-200">
                                <input type="number" name="stock" required class="border border-slate-300 rounded-md px-2 py-1 w-full" value="{{ $product->stock }}" >
                            </td>
                        </tr>
                    </table>
